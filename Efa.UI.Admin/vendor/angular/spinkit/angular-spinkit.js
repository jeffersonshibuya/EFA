...
angular.module('ngRotatingPlaneSpinner', []).directive('rotatingPlaneSpinner', function () {
  return {
    restrict: 'E',
    templateUrl: 'vendor/angular/spinkit/templates/rotatingPlaneSpinner.html'
  };
});
...
angular.module('ngDoubleBounceSpinner', []).directive('doubleBounceSpinner', function () {
  return {
    restrict: 'E',
    templateUrl: 'vendor/angular/spinkit/templates/doubleBounceSpinner.html'
  };
});
...
angular.module('ngWaveSpinner', []).directive('waveSpinner', function () {
  return {
    restrict: 'E',
    templateUrl: 'vendor/angular/spinkit/templates/waveSpinner.html'
  };
});
...
angular.module('ngWanderingCubesSpinner', []).directive('wanderingCubesSpinner', function () {
  return {
    restrict: 'E',
    templateUrl: 'vendor/angular/spinkit/templates/wanderingCubesSpinner.html'
  };
});
...
angular.module('ngPulseSpinner', []).directive('pulseSpinner', function () {
  return {
    restrict: 'E',
    templateUrl: 'vendor/angular/spinkit/templates/pulseSpinner.html'
  };
});
...
angular.module('ngChasingDotsSpinner', []).directive('chasingDotsSpinner', function () {
  return {
    restrict: 'E',
    templateUrl: 'vendor/angular/spinkit/templates/chasingDotsSpinner.html'
  };
});
...
angular.module('ngCircleSpinner', []).directive('circleSpinner', function () {
  return {
    restrict: 'E',
    templateUrl: 'vendor/angular/spinkit/templates/circleSpinner.html'
  };
});
...
angular.module('ngThreeBounceSpinner', []).directive('threeBounceSpinner', function () {
  return {
    restrict: 'E',
    templateUrl: 'vendor/angular/spinkit/templates/threeBounceSpinner.html'
  };
});
...
angular.module('ngCubeGridSpinner', []).directive('cubeGridSpinner', function () {
  return {
    restrict: 'E',
    templateUrl: 'vendor/angular/spinkit/templates/cubeGridSpinner.html'
  };
});
...
angular.module('ngWordPressSpinner', []).directive('wordPressSpinner', function () {
  return {
    restrict: 'E',
    templateUrl: 'vendor/angular/spinkit/templates/wordPressSpinner.html'
  };
});
...
angular.module('ngFadingCircleSpinner', []).directive('fadingCircleSpinner', function () {
  return {
    restrict: 'E',
    templateUrl: 'vendor/angular/spinkit/templates/fadingCircleSpinner.html'
  };
});
