...
namespace Efa.Infra.CrossCutting.Identity
{
    public class ApplicationUser : IdentityUser
    {
        ...
        public async Task<ClaimsIdentity> GenerateUserIdentityAsync(UserManager<ApplicationUser> manager, string authenticationType = "", ClaimsIdentity ext = null)
        {
